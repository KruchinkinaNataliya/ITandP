...
public class Main {
    ...
    */
     ...
     */
    public static StringBuilder alphCount(String str) { // task 5
        StringBuilder res = new StringBuilder();
        ArrayList<String> letters = new ArrayList<>(); //хранение подсчета подряд идущих букв
    ...
    public static String uniqueSubstring(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (i - startIndex + 1 > longestSubstring.length()) { //i - startIndex + 1 длина текущей подстроки
